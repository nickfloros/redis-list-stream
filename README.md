...
[![Build Status](https://dev.azure.com/NickFloros/redis-list-stream/_apis/build/status/nickfloros.redis-list-stream?branchName=master)](https://dev.azure.com/NickFloros/redis-list-stream/_build/latest?definitionId=15&branchName=master)
