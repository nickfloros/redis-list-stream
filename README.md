# redis-list-stream
[![Node.js CI](https://github.com/nickfloros/redis-list-stream/actions/workflows/node.js.yml/badge.svg)](https://github.com/nickfloros/redis-list-stream/actions/workflows/node.js.yml)
